...
public class MedicosDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        textCRM2 = new javax.swing.JTextField();
        ...
        text_Codigo.setBounds(20, 70, 71, 30);

        jLabel3.setFont(new java.awt.Font("SansSerif", 1, 12)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(51, 0, 0));
        jLabel3.setText("Telefone");
        jPanel2.add(jLabel3);
        jLabel3.setBounds(10, 160, 110, 16);
        ...
        textEmail.setBounds(140, 180, 440, 30);
        ...
        buttonSalvar.setBounds(660, 320, 80, 60);
        ...
        textTelefone.setBounds(10, 180, 120, 30);

        jLabel4.setFont(new java.awt.Font("SansSerif", 1, 12)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(51, 0, 0));
        jLabel4.setText("Data Nascimento");
        jPanel2.add(jLabel4);
        jLabel4.setBounds(590, 160, 110, 16);

        textCRM2.setBackground(new java.awt.Color(204, 204, 204));
        textCRM2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                textCRM2ActionPerformed(evt);
            }
        });
        jPanel2.add(textCRM2);
        textCRM2.setBounds(590, 180, 120, 30);
        ...
        jPanel2.add(textCRM);
        textCRM.setBounds(100, 70, 120, 30);

        jLabel7.setFont(new java.awt.Font("SansSerif", 1, 12)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(51, 0, 0));
        jLabel7.setText("CRM");
        jPanel2.add(jLabel7);
        jLabel7.setBounds(100, 50, 50, 16);
        ...
        buttonCancelar1.setBounds(570, 320, 80, 60);
...
//------------------------------------------------------------------------------
    ...
    private void textCRM2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_textCRM2ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_textCRM2ActionPerformed
  ...
  private boolean validarCadastroMedico() {
    ...
    private javax.swing.JTextField textCRM2;
